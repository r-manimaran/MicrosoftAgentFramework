...
public class AgentThreadPersistence
{
    ...
    public static async Task<AgentThread> ResumeChatIfRequestedAsync(AIAgent agent)
    {
        ...
        {
            Console.WriteLine("Restore previous conversation? (Y/N) :");
    ...
    public static async Task StoreThreadAsync(AgentThread thread)
    {
        ...
        await File.WriteAllTextAsync(ConversationPath, JsonSerializer.Serialize(serializedThread, new JsonSerializerOptions { WriteIndented = true }));
    }
}
